...
export default function ApproachSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-white py-32 px-6 md:px-24 overflow-hidden border-t border-slate-100"
    >
      <div
        className="absolute inset-0 opacity-[0.02] pointer-events-none"
        style={{
          backgroundImage: "radial-gradient(#0b1236 1px, transparent 1px)",
          ...
          {approach.items.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-8 h-px bg-slate-100 w-full relative">
