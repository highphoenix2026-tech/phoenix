  ...
  return (
    <div className={`group relative inline-block w-full sm:w-auto ${className}`}>
      ...
      <Link
        ...
        style={{ transform: 'skewX(25deg)' }}
      >
        <div className="flex items-center gap-3 sm:gap-6 md:gap-8 lg:gap-10" style={{ transform: 'skewX(-25deg)' }}>
          ...
          <div className="relative w-5 h-5 sm:w-5 md:w-6 lg:w-7 overflow-hidden flex items-center justify-center shrink-0">
            <FaPlane className="text-sm sm:text-base md:text-xl lg:text-2xl -rotate-45 transition-transform duration-500 group-hover:translate-x-12 group-hover:-translate-y-12" />
            <FaPlane className="text-sm sm:text-base md:text-xl lg:text-2xl absolute -left-12 top-12 -rotate-45 transition-transform duration-500 group-hover:translate-x-12 group-hover:-translate-y-12" />
          </div>
        </div>
