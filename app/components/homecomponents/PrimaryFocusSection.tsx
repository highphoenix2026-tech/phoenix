...
export default function PrimaryFocusSection() {
  ...
  return (
    <section
      ref={container}
      className="relative py-24 px-6 md:px-24 bg-[#0b1236] text-white overflow-hidden"
    >
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="animate-me opacity-0 translate-y-8 focus-card md:col-span-8 relative p-10 bg-white/5 group">
            ...
            <div className="relative z-10">
              <div className="text-[#c9a24d] mb-6 ">
                <FaUserTie className="no-flip" size={35} />
              </div>
          ...
          <div className="animate-me opacity-0 translate-y-8 focus-card md:col-span-4 relative bg-[#c9a24d] p-10 text-[#0b1236]">
            ...
            <FaGavel size={40} className="mb-8 opacity-80 no-flip" />
          ...
          {primaryFocus.services.slice(2, 4).map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="animate-me opacity-0 translate-y-8 focus-card md:col-span-6 relative p-8 bg-white/5 group border-l-2 border-[#c9a24d]/10 hover:border-[#c9a24d] transition-all duration-500"
              >
                ...
                <div className="flex gap-6 items-start">
                  <div className="text-[#c9a24d] mt-1">
                    <Icon size={24} className="no-flip" />
                  </div>
                  <div>
        ...
        <div className="animate-me opacity-0 translate-y-8 flex justify-center mt-16">
          <Button2 href="/advisory"> {primaryFocus.cta}</Button2>
        </div>
      </div>
    </section>
  );
