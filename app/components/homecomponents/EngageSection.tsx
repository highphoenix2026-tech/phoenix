...
export default function EngageSection() {
  ...
  return (
    <section
      ref={container}
      className="relative bg-white py-32 px-6 overflow-hidden border-t border-slate-100"
    >
      <div
        className="absolute inset-0 opacity-[0.03] pointer-events-none"
        style={{
          backgroundImage: "radial-gradient(#0b1236 0.5px, transparent 0.5px)",
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-12 items-center gap-12">
        ...
        <div className="md:col-span-4 flex flex-col items-center md:items-end">
          <div className="engage-white-animate opacity-0 translate-y-10 w-full max-w-70">
            <Button2 href="/contact"> {engage.cta}</Button2>

            <p className="mt-4 font-mono text-[9px] text-slate-400 text-center md:text-right uppercase tracking-tighter">
              {isArabic? "* وقت الاستجابة خلال 24 ساعة":"* Response time within 24 operational"}
            </p>
          </div>
        </div>
      </div>
      ...
      <div
        className="absolute bottom-0 right-0 w-32 h-32 bg-slate-50 opacity-50 clip-path-diagonal hidden md:block"
