...
export const contactData = {
  ...
  ar: {
    hero: {
      title: "اتصل بنا",
      desc:
        "تتعامل العنقاء للاستشارات الجوية مع العملاء من خلال مهام استشارية مخصصة وبرامج تدريبية مصممة لتلبية الأهداف المؤسسية والتنظيمية والتشغيلية."
    },
    engagement: [
      {
        icon: "FaBusinessTime",
    ...
    professional: {
      title: "تنويه مهني",
      desc1:
        "تعمل العنقاء للاستشارات الجوية كشركة استشارية وتدريبية مستقلة. جميع المهام تنفذ بسرية تامة ووفق الشروط المتفق عليها ونطاق العمل المحدد.",
      desc2:
